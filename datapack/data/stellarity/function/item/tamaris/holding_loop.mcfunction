...
execute as @e[type=!#kohara:invalid_targets,type=!player,tag=stellarity.item.tamaris.executable,distance=0.01..20] at @s anchored eyes rotated ~ 0 run function stellarity:item/tamaris/execute/indicator
