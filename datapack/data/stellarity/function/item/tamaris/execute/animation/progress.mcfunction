...
# Executing things as entity in question
  execute if score @s stellarity.item.tamaris.animation.progress matches 5 as @n[type=!#kohara:invalid_targets,type=!player,distance=0.1..100,tag=stellarity.item.tamaris.executable] at @s run function stellarity:item/tamaris/execute/animation/as_entity/kill
